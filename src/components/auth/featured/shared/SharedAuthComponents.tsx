...
import { GoogleSignIn } from "@/hooks/auth/GoogleSignInButton";
...
export function BaseAuthForm({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 w-full h-full hide-scrollbar transition-colors duration-200 rounded-md border">
