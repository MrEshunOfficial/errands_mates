...
const FeaturedCarousel = () => {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-scroll justify-between relative p-2 hide-scrollbar bg-gradient-to-b from-blue-50 to-gray-100 dark:from-slate-900 dark:to-slate-950 w-full">
      {/* Header section */}
