...
import { Category, FileReference } from "@/types";
...
const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  const handleImageUploadSuccess = useCallback(
    (uploadedImageData: FileReference) => {
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        const apiData = {
          ...
          // Include image data for both create and edit modes
  ...
  return (
    <div
      className={`container mx-auto max-w-3xl p-4 border rounded-md shadow-2xl ${className}`}
    >
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            {isEdit
              ...
              : "Organize your services with a new category"}
          </p>
        </motion.div>
